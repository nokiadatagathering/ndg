...
//        area.setSelection(0, area.text.length); //Temporary fix to avoid Error: Call to a possibly undefined method setSelection through a reference with static type spark.components:TextArea.
    }
...
//        area.setSelection(0, area.text.length);             // Flex 3
    ...
    //Search, Upload CSV File and Clear List
